        ...
        <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" aria-label="Navegación principal">
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <a href="{{ route('home') }}" class="flex items-center gap-3 group" aria-label="MoniWis Sushi - Inicio">
                    <div class="w-12 h-12 rounded-full overflow-hidden group-hover:scale-110 transition-transform duration-300 flex-shrink-0"
                         style="box-shadow: 0 4px 10px rgba(232,25,44,0.4);">
                        <img src="{{ asset('images/logo-cat-normal.jpg') }}" alt="MoniWis Sushi logo gato cálico" class="w-full h-full object-cover">
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    <div class="flex items-center gap-3 mb-4">
                        <div class="w-12 h-12 rounded-full overflow-hidden flex-shrink-0" style="box-shadow: 0 4px 10px rgba(232,25,44,0.3);">
                            <img src="{{ asset('images/logo-cat-normal.jpg') }}" alt="MoniWis Sushi" class="w-full h-full object-cover">
                        </div>
                        <div>
